...
def build_coarse_screener_tools() -> List[Any]:
    def run_coarse_screen_batch(
        ...
        try:
            ...
            resolved_context.update_task_phase("coarse_screen", runtime=runtime, active_plan_version=version, run_id=str(batch.get("run_id") or ""), active_batch_id=batch_id)
            ...
            return resolved_context.record_todo_failure("coarse_screen", str(exc), current_task="coarse_screen", resume_from="run_coarse_screen_batch")
