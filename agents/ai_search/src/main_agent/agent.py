...
from agents.ai_search.src.subagents.claim_decomposer import build_claim_decomposer_subagent
from agents.ai_search.src.subagents.claim_search_strategist import build_claim_search_strategist_subagent
...
def build_main_agent(storage: Any, task_id: str):
    ...
    return create_deep_agent(
        ...
        subagents=[
            ...
            build_claim_decomposer_subagent(storage, task_id),
            build_claim_search_strategist_subagent(storage, task_id),
