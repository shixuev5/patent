...
CREATE TABLE IF NOT EXISTS ai_search_execution_message_queue (
...
CREATE INDEX IF NOT EXISTS idx_ai_search_execution_message_queue_run_status ON ai_search_execution_message_queue(task_id, run_id, status, ordinal);
CREATE INDEX IF NOT EXISTS idx_ai_search_execution_message_queue_task_created ON ai_search_execution_message_queue(task_id, created_at);
