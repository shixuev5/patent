...
from patent_agents.common.utils.http import request_with_retry
...
def test_request_with_retry_retries_then_succeeds(monkeypatch):
    ...
    monkeypatch.setattr("patent_agents.common.utils.http.requests.request", fake_request)
    monkeypatch.setattr("patent_agents.common.utils.http.time.sleep", sleeps.append)
