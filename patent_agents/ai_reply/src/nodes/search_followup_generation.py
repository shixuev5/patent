...
from patent_agents.ai_reply.src.state import SearchFollowupSection
from patent_agents.ai_reply.src.utils import PipelineCancelled, ensure_not_cancelled, get_node_cache
from patent_agents.ai_reply.src.retrieval_followup import should_run_followup_by_assessment
from patent_agents.ai_search.src.search_elements import (
    normalize_date_text,
