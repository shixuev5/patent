...
from patent_agents.common.retrieval.academic_search import (
    AcademicSearchClient,
    load_api_keys,
    safe_json,
)
from patent_agents.common.retrieval.academic_query_utils import normalize_academic_dispatch_query
